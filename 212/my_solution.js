...
var findWords = function (board, words) {
  ...
  const exploreNextWord = (children, r, c, str) => {
    console.log(`r:${r},c:${c},str:${str}`) // ,cidx:${trieNode.getIdx(board[r][c])}
    ...
    console.log(`>>> current char:${board[r][c]}`)
    let childTrieNode = children[trieNode.getIdx(board[r][c])];
    str += board[r][c];

    console.log("childTrieNode")
    console.log(childTrieNode)
    // console.log("trieNode.getIdx(board[r][c])")
    // console.log(trieNode.getIdx(board[r][c]))
    if (childTrieNode === null) {
      ...
      if (!foundSet.has(str)) {
        ...
        console.log(`>>>> DOES NOT FOUND IN SET -- str:${str}`)
      }
    }
    ...
    // if (res) {
    //   console.log("!!OJQWDIOJEIOWJIOJDIOJWQIJODJOIDWJOIDWQOJIDJOIDWIOJWDQOIJWOIJDOJIDW")
    //   console.log(str)
    // }
  ...
  for (let r = 0; r < board.length; r++) {
    for (let c = 0; c < board[r].length; c++) {
      ...
      // if (trieNode.children[trieNode.getIdx(board[r][c])]) {
      //   console.log(`have ${board[r][c]}`)
      // if (exploreNextWord(trieNode.children, 0, r, c) && !foundList.includes(word)) {
...
let x =
  findWords(
    ...
    // e: ["oath","oathk","oathf","oathfi","oathfii","oathi","oathii","oate","eat"]
    [
      ["o", "a", "a", "n"],
      ["e", "t", "a", "e"],
      ["i", "h", "k", "r"],
...
// console.log("___ trieNode")
// let tn = new TrieNode()
// console.log(tn.children)
// console.log(tn.insert("atry"))
// console.log(tn.children[0].children[19].children[17])
// // console.log(tn.search("atry"))
